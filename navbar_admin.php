...
<body>
<div class="navbar">
    <a href="Admin_Index.php" id="home-link">Home</a>
    <a href="admin_view_records.php">View Records</a>
    <a href="registration.php">Add Student</a>
    <a href="admin_course.php">Course</a>
    <a href="faculty.php">Add Faculty</a>
   
    <a href="about_admin.php">About Us</a>
